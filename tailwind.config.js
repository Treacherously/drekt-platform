...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      // Font weights matching Figma design
      fontWeight: {
        'light': '200',
        'normal': '400',
        'medium': '500',
      ...
      colors: {
        ...
        // Semantic colors for supply chain dashboard
        status: {
          'in-transit': '#3b82f6',
          'delivered': '#22c55e',
          'pending': '#f59e0b',
      ...
      // Spacing scale for dashboard layouts
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
        '128': '32rem',
      ...
      boxShadow: {
        ...
        'dashboard': '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -1px rgb(0 0 0 / 0.06)',
  ...
  plugins: [
    // Add custom utilities for dashboard components
